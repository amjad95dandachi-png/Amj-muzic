...
<title>Amj Muzic — Canvas Lines</title>
<style>
...
window.addEventListener('touchmove', e=>{ if(e.touches[0]){updatePointer(e.touches[0].clientX,e.touches[0].clientY); lastMove=Date.now();}}, {passive:true});
